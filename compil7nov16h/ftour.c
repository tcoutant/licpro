...
*/
int joueLeCoup(plateau p, int NumLigne, int NumColonne, int joueur)//Joue un coup
{
	int nb;
      p[NumLigne][NumColonne]=joueur;								//Retourne le pion avec la couleur du joueur

      nb = retournePions(joueur,p,NumLigne,NumColonne);					//Appel de la fonction retournePions
...
int joueLeCoupSansAffiche(plateau p, int NumLigne, int NumColonne, int joueur)//Joue un coup
{
	int nb;
      p[NumLigne][NumColonne]=joueur;								//Retourne le pion avec la couleur du joueur
...
int donneTousLesCoupsValidesSansAffiche(plateau p, int joueur, Maillon ** teteMaillon)
{
   int i,j,cpt;
   Maillon * courantMaillon;
   Maillon * newMaillon;
...
/*
	Fonction qui duplique un plateau, pour pouvoir tester des coups.
*/
...
/*
	Fonction qui renvoie l'adversaire du joueur passé en parametre
*/
