				...
				case 2: // mode 1 joueur contre l'ordi a été choisi
					...
					switch(menu)
					{
						...
						case 4: // niveau moyen, joue la case maitresse par rapport à sa situation
							...
							main();
							break;
						case 5: //niveau expert, utilisation de minmax
							HumainVsCPUMinMax();
							main();
	  						break;
						case 6:
							...
							printf("\t|                                                    |\n");
							printf("\t|   		Niveaux de Jeu			       |\n");
							printf("\t|       									           |\n");
							printf("\t______________________________________________________\n");
							printf(" Random : L'ordinateur joue un coup aléatoirement parmi la liste des coups possibles \n\n");
							printf(" MaxPions : L'ordinateur joue le coup retournant le maximum de pions.\nSi plusieurs coups retournent le même nombre de pions, il choisi aléatoirement parmi ceux-ci\n\n");
							printf(" MinOptions : L'ordinateur joue le coup laissant le minimum d'options à son adversaire.\nSi plusieurs coups donnent le même nombre d'options, il choisi aléatoirement parmi ceux-ci\n\n");
							printf("\n");
							printf(" MaxValeurCase : Chaque case du plateau est associée à un coefficient (en fonctions de leur valeur stratégique), et l'ordinateur joue le coup le plus avantageux(les coins valent 800 points, les bords 300, etc...)\n");
							printf("\n");
							printf(" MinMax : L'ordinateur crée un arbre, et simule tous les coups possibles, avec une profondeur variable, pour trouver le coup le plus avantageux.\n");
							printf("\n\n\n");
